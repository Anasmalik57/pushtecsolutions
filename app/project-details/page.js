                ...
                <div className="project-details-left-content">
                  ...
                  <div className="text">
                    <p className="first-text">
                      Materials science is important for the development of
                      technology and has been or thousands of years. Different
                      materials have different strengths and weaknesses and are
                      better for different purposes. Since technology is the
                      process of using our scientific knowledge to create
                      devices and objects that benefit humans, understanding
                      materials is an important step in this process.
                    </p>
                    <p className="second-text">
                      The more you understand the materials that you have choose
                      from, the better choices you will make. Materials studied
                      in materials science can be anything from simple materials
                      like wood, to modern man-made materials like plastic, to
            ...
            <div className="row">
              ...
              <div className="col-xl-4">
                <div className="project-details-benifits">
                  ...
                  <div className="text">
                    <p>
                      Learn how to optimize manufacturing systems performance
                      and control cos Design and Fabrication of External Pipe
                      Climbing Robot.
                    </p>
                  </div>
                  <ul>
                    <li>
                      <i className="fa fa-angle-right"></i>Delivery on Time
                    </li>
                    <li>
                      <i className="fa fa-angle-right"></i>Professional
                      Engineerr
                    </li>
                    <li>
                    ...
                    <li>
                      <i className="fa fa-angle-right"></i>Strategy Maintains
                    </li>
                  </ul>
                </div>
              </div>
