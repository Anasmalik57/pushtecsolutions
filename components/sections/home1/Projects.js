  ...
  return (
    <>
      ...
      <section className="latest-projects-one-section">
        <div
          className="latest-projects-one-bg"
          style={{
            backgroundImage: "url(assets/images/background/project-1-bg.png)",
          }}
        ></div>
          ...
          <div className="row">
            <div className="col-xl-4">
              <div className="latest-pro-one-title">
                ...
                <p>
                  Pushtec Solutions Leads with Tailored Machinery for FMCG
                  Excellence. Factories are the foundation of innovative
                  manufacturing.
                </p>
              </div>
            </div>
                ...
                <div className="latest-pro-one-img-box">
                  ...
                  <div className="latest-pro-one-img-title">
                    <div className="content">
                      <h5>
                        <Link href="#">Metal & Materials</Link>
                      </h5>
                    </div>
                    <div className="icon">
                      <Link
                        className="img-popup"
                        href="assets/images/project/project-1-img-1.jpg"
                      >
              ...
              <div className="latest-pro-one-single">
                <div className="latest-pro-one-img-box">
                  ...
                  <div className="latest-pro-one-img-title">
                    <div className="content">
                      <h5>
                        <Link href="#">Welding Industry</Link>
                      </h5>
                    </div>
                    <div className="icon">
                      <Link
